...
import { idlFactory } from './todo_backend.did.js';
export { idlFactory } from './todo_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TODO_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./todo_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the todo_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./todo_backend.did.js")._SERVICE>}
 */
export const todo_backend = createActor(canisterId);
